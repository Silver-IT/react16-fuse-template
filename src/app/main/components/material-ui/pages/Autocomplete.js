            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationDownshift.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationDownshift.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationReactSelect.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationReactSelect.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationAutosuggest.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/autocomplete/IntegrationAutosuggest.js')}
                    /></Typography>
