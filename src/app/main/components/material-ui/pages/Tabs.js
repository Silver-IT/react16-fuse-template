            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/SimpleTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/SimpleTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/TabsWrappedLabel.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/TabsWrappedLabel.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/DisabledTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/DisabledTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/FullWidthTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/FullWidthTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/CenteredTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/CenteredTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonAuto.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonAuto.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonForce.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonForce.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonPrevent.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/ScrollableTabsButtonPrevent.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/CustomizedTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/CustomizedTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/NavTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/NavTabs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/tabs/IconTabs.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/IconTabs.js')}
                    />
                        <FuseExample
                            className="my-24"
                            iframe={false}
                            component={require('app/main/components/material-ui/material-ui-examples/tabs/IconLabelTabs.js').default}
                            raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/tabs/IconLabelTabs.js')}
                        /></Typography>
