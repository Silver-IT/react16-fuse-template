            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/OutlinedTextFields.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/OutlinedTextFields.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/FilledTextFields.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/FilledTextFields.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/ComposedTextField.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/ComposedTextField.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        ...
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/Inputs.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/InputAdornments.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/InputAdornments.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/InputWithIcon.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/InputWithIcon.js')}
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Filled Input Adornments</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/FilledInputAdornments.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/FilledInputAdornments.js')}
                    /></Typography>
                    <Typography className="text-24 mt-32 mb-8" component="h3">Outlined Input Adornments</Typography>
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/OutlinedInputAdornments.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/OutlinedInputAdornments.js')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        iframe={false}
                        component={require('app/main/components/material-ui/material-ui-examples/text-fields/TextFieldMargins.js').default}
                        raw={require('!raw-loader!app/main/components/material-ui/material-ui-examples/text-fields/TextFieldMargins.js')}
                    /></Typography>
